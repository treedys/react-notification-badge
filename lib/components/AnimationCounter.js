...
var requestAnimationFrame = function () {
  if (typeof window === 'undefined') {
    ...
    return (window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || defaultSetTimeout).bind(window);
  }
}();
...
var cancelAnimationFrame = function () {
  if (typeof window === 'undefined') {
    ...
    return (window.cancelAnimationFrame || window.webkitCancelAnimationFrame || window.mozCancelAnimationFrame || window.oCancelAnimationFrame || window.msCancelAnimationFrame || defaultClearTimeout).bind(window);
  }
}();
